...
description: 'Welcome to the Exchange Rates API - Official Reserve Bank of Australia exchange rate data for programmatic access through REST API endpoints'
---
