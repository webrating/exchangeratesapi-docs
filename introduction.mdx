...
The Exchange Rates API is a developer-focused data service providing **official Reserve Bank of Australia (RBA) exchange rate data** through clean, modern REST API endpoints. We transform publicly available and free RBA data (currently only accessible via HTML/RSS) into instant JSON responses.
...
<Note>
All data is sourced from the Reserve Bank of Australia. We are not affiliated with or endorsed by the RBA. See our [compliance guide](/guides/compliance) for attribution requirements.
</Note>
