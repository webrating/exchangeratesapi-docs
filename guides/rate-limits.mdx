...
| Plan | Price (AUD/month) | Monthly Requests | Historical Data | Timeseries Max Range | Support |
|------|-------------------|------------------|-----------------|----------------------|---------|
| **Free** | $0 | 300 | None | No access | Community |
| **Starter** | $29 | 5,000 | Last 30 days | 7 days | Email (48h) |
| **Professional** | $79 | 50,000 | Full (2018+) | 90 days | Email (24h) |
| **Business** | $299 | 500,000 | Full (2018+) | 365 days | Phone (4h) |
