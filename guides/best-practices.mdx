...
// Usage
const quotaManager = new QuotaManager('buderim_your_api_key_here');
...
// Usage
const batcher = new BatchProcessor('buderim_your_api_key_here');
...
// Usage
const monitor = new APIMonitor('buderim_your_api_key_here');
