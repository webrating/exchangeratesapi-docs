...
<CardGroup cols={2}>
  <Card
    ...
    icon="filter"
    href="/api-reference/authenticated/latest-currency"
  >
  ...
  <Card
    ...
    icon="calculator"
    href="/api-reference/authenticated/convert-authenticated"
  >
  ...
  <Card
    ...
    icon="history"
    href="/api-reference/authenticated/historical-date"
  >
