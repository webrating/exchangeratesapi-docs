...
<ParamField query="from" type="string" required>
  Source currency code. All supported currencies are available for conversion.
...
<ParamField query="date" type="string" optional>
  ...
  <Note>Historical dates: Free plan users can access last 7 days. Paid plans have full historical access.</Note>
</ParamField>
...
```bash cURL - Latest Rates (AUD to USD)
...
| Historical Dates | ✅ Last 7 days | ✅ Full access (7 days free, unlimited paid) |
