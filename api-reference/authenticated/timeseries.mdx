---
title: 'Historical Exchange Rates (/timeseries)'
...
<ParamField query="start_date" type="string" required>
  ...
  **Free Plan**: Limited to last 7 days only  
...
<ParamField query="end_date" type="string" required>
  ...
  **Free Plan**: Maximum 7 days range  
  **Starter Plan**: Maximum 30 days range  
...
<Warning>
**Free Plan**: Last 7 days access with 7-day maximum range  
**Starter Plan**: 90 days access with 30-day maximum range  
