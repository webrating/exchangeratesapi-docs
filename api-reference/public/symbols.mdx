...
```json Success Response
{
  ...
  "symbols": {
    ...
    "TWI": {
      ...
      "symbol": "TWI",
      "country": "Australia",
      "note": "Not available for conversion operations"
    },
    "SDR": {
...
<ResponseField name="symbols.{code}.note" type="string">
  Additional information about currency limitations (e.g., TWI conversion restrictions)
</ResponseField>
