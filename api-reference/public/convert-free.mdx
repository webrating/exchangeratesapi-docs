...
<ParamField query="from" type="string" required>
  Source currency code (must be "AUD" for free tier)
</ParamField>
...
Free conversions **must use AUD as the source currency**:
...
<CardGroup cols={2}>
  <Card
    ...
    href="/quickstart"
  >
    Sign up for free and get 50 requests/day
  </Card>
  <Card
    title="View Plans"
    icon="credit-card"
