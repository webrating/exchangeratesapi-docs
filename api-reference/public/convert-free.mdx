...
The free conversion endpoint allows you to convert between AUD and other supported currencies without authentication. This is perfect for testing, demos, and light usage scenarios.
...
```json
{
  ...
  "error": {
    "code": 400, 
    "type": "bad_request",
    "info": "Free tier conversions must use AUD as base currency"
  }
}
```
...
<CardGroup cols={2}>
  ...
  <Card
    title="View Plans"
    icon="credit-card"
    href="https://exchangeratesapi.com.au/pricing"
  >
