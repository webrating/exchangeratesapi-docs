...
Want to try the API at no cost? Sign up for a [free API key](https://app.exchangeratesapi.com.au/login) (300 requests/month) and use it on any endpoint, including `/convert`:
