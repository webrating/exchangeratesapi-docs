...
<Steps>
  <Step title="Sign Up">
    ...
    <Note>No credit card required for the free tier (150 requests to get started)</Note>
  </Step>
...
Want to try the API at no cost? Sign up for a [free API key](https://app.exchangeratesapi.com.au/login) (150 requests) and use it on any endpoint, including `/convert`:
